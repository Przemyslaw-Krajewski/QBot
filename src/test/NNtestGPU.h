...
namespace Test
{
	...
	void gpuSigmoidNNSmokeTest()
	{
		...
		nn.addLayer(new NeuralNetworkGPU::SigmoidLayer(13.2,0.3,1,nn.getLastLayerNeuronRef()));
    ...
    void testPeak3LayersGPU()
    {
    	NeuralNetworkGPU::NeuralNetwork nn;
        nn.addLayer(new NeuralNetworkGPU::InputLayer(1));
        nn.addLayer(new NeuralNetworkGPU::SigmoidLayer(16.2,0.006, 30, nn.getLastLayerNeuronRef()));
    ...
    void testPeak3LayersAdamGPU()
    {
        ...
        nn.addLayer(new NeuralNetworkGPU::InputLayer(1));
        nn.addLayer(new NeuralNetworkGPU::SigmoidLayer(11.2,0.0006, 30, nn.getLastLayerNeuronRef()));
